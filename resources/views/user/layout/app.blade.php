...
<head>
    ...
    <title>{{ Setting::get('site_title','Uberlikeapp') }}</title>
    ...
    <div class="container pad-60"">
        <div class="row center">
            ...
            <div class="col-md-6">
              <div class="">
                 <div class="col-md-6">
                 <a target="_blank" href="{{Setting::get('store_link_ios_user','#')}}">
            <img src="{{asset('asset/img/user-appstore.png')}}">
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                 <a target="_blank" href="{{Setting::get('store_link_android_user','#')}}">
           ...
           <div class="col-md-6">
              <div class="">
                 <div class="col-md-6">
                 <a target="_blank" href="{{Setting::get('store_link_ios_provider','#')}}">
            <img src="{{asset('asset/img/provider-appstore.png')}}">
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                 <a target="_blank" href="{{Setting::get('store_link_android_provider','#')}}">
        ...
        <div class="row center">
            ...
            <div class="col-md-6 col-md-offset-3">
                 <div class="socil-media">
                   <ul>
                                    <li><a target="_blank" href="{{Setting::get('store_facebook_link','#')}}"><i class="fa fa-3x fa-facebook"></i></a></li>
                                    <li><a target="_blank" href="{{Setting::get('store_twitter_link','#')}}"><i class="fa fa-3x fa-twitter"></i></a></li>
                                </ul>
                 </div>
             </div>
    </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>{{ Setting::get('site_title','Uberlikeapp') }} is available in your city</p>
      </div>
