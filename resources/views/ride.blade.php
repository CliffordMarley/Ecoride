            ...
            <div class="col-md-4">
                <div class="banner-form">
                    <div class="row no-margin fields">
                        ...
                        <div class="right">
                            <a href="{{url('login')}}">
                                <h3>Ride with {{Setting::get('site_title','Uberlikeapp')}}</h3>
    ...
    <div class="row white-section pad-60 no-margin">
        <div class="container ">
            ...
            <div class="col-md-4 content-block small">
                ...
                <div class="title-divider"></div>
                <p>When you arrive at your destination, either pay with cash or have your card automatically charged. With {{ Setting::get('site_title', 'Uberlikeapp') }}, the choice is yours.</p>
            </div>
        </div>
