...
class DispatcherList extends React.Component {
    ...
    componentDidMount() {
        ...
        window.Uberlikeapp.TripTimer = setInterval(
            () => this.getTripsUpdate(),
            1000
        );
    }
    ...
    componentWillUnmount() {
        clearInterval(window.Uberlikeapp.TripTimer);
    }
...
class DispatcherRequest extends React.Component {
    ...
    componentDidMount() {
        ...
        $('#schedule_time').datetimepicker({
            minDate: window.Uberlikeapp.minDate,
            maxDate: window.Uberlikeapp.maxDate,
        });
